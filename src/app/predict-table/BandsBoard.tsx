...
function PlacedTeamCard({
  ...
  return (
    <button
      ...
      } ${liftedHere ? "border-accent bg-accent/10 ring-2 ring-accent/50" : overfilled ? "border-danger/50 bg-danger/10 hover:border-danger" : !emphasis ? "border-paper-line bg-white hover:border-accent/50" : ""} ${justSwapped ? "motion-safe:animate-swap-pulse" : ""} ${celebrate ? "motion-safe:animate-swap-pulse" : ""}`}
    >
      <span
        aria-hidden
