...
export function SwitchPlayerButton() {
  ...
  return (
    <button
      ...
      className={`fixed top-[calc(0.75rem+env(safe-area-inset-top))] right-3 z-10 flex size-10 items-center justify-center rounded-badge border border-paper-line bg-paper text-ink shadow-lg shadow-ink/25 transition disabled:opacity-50 ${FOCUS}`}
    >
